...
${expression ? 'Expression: "' + expression + '"\n\n' : ''}`,
        ...
        directive(
          'modelable',
          (el, { expression }, { effect: effect3, evaluate: evaluate2, evaluateLater: evaluateLater2 }) => {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        validators.transitional = function transitional(validator, version, message) {
          ...
          function formatMessage(opt, desc) {
            return (
              '[Axios v' + pkg.version + "] Transitional option '" + opt + "'" + desc + (message ? '. ' + message : '')
            );
          }
  ...
  \*****************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var alpinejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
